...
int main(){
    ...
    printf("Digite o num da matriz bidimensional (um valor para linha e coluna)\n");
    scanf("%d", &nMatriz);

    int matriz[nMatriz] [nMatriz];

    printf("Digite o valor das distancia de cada grafo (0 para sem caminho). Lembrando que a quantidade de valores digitados sera n*n\n");
    ...
    printf("Digite a cidade de inicio\n");
    scanf("%d", &inicio);
